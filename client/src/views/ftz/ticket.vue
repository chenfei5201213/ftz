    ...
    <el-dialog
      ...
      <el-form
        ...
        <el-form-item label="卡片标题" prop="name">
          <el-input v-model="workflow.name" placeholder="卡片标题"  style="width: 150px"/>
        </el-form-item>
        <el-form-item label="卡片类型">
          <el-select v-model="workflow.region" placeholder="卡片类型" style="width: 150px">
            <el-option v-for="(item, index) in field101Options" :key="index" :label="item.label"
                       :value="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="分组" prop="description">
          <el-input v-model="workflow.sn_prefix " placeholder="分组" style="width: 150px"/>
        </el-form-item>
        <el-form-item label="状态">
          <el-radio-group v-model="workflow.resource">
        ...
        <el-form-item label="卡片核心图" prop="dept">
          <el-upload
            ...
            :headers="upHeaders"
          >
            <img v-if="workflow.avatar" :src="workflow.avatar" class="avatar" />
            <i v-else class="el-icon-plus avatar-uploader-icon" />
          </el-upload>
        </el-form-item>
        <el-form-item label="话题" prop="description">
          <el-input v-model="workflow.sn_prefix " placeholder="话题" style="width: 150px"/>
        </el-form-item>
        <el-form-item label="难度">
          <el-select v-model="workflow.region" placeholder="难度" style="width: 150px">
            <el-option v-for="(item, index) in field101Options" :key="index" :label="item.label"
                       :value="item.value"></el-option>
          </el-select>
        </el-form-item>
