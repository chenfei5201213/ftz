...
class CourseScheduleContentCache:
    ...
    def add_material(self, study_material_id, study_material_info: dict):
        # sml 素材详情，课程+课时维度
        # sid 素材id
    ...
    def get_previous_material(self, study_material_id):
        # 获取当前素材ID在有序列表中的排名
        study_material_cache_key = to_redis_key('sid', self.course_id, self.lesson_id, study_material_id)
    ...
    def get_next_material(self, study_material_id):
        # 获取当前素材ID在有序列表中的排名
        study_material_cache_key = to_redis_key('sid', self.course_id, self.lesson_id, study_material_id)
